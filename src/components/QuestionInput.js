            ...
            <div className={styles.question}>
                ...
                <form>
                    ...
                    <div className={styles.input} >
                        <Select variant="standard" value={firstValue} onChange={(e)=>setFirstValue(e.target.value)} >
                        {Object.keys(firstChoice).map((key) => (<MenuItem value={firstChoice[key]}>{key}</MenuItem>))}
                        </Select> 
                    </div>
                    <div className={styles.input} >
                        <Select   variant="standard" value={secondValue} onChange={(e)=>setSecondValue(e.target.value)} >
